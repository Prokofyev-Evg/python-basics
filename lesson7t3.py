...
class Cell:
    ...
    def __sub__(self, other):
        val = self.qty - other.qty
        if val >= 0:
            return Cell(val)
        print("Не хватает клеток")
    ...
    def make_order(self, width):
        print(f"{'*' * width}\n" * (self.qty // width) + '*' * (self.qty % width))
...
print(f'Вычитание из меньшего большее - {c1 - c2}')
print(f'Вычитание из большего меньшее - {c2 - c1}')
print(f'Умножение - {c1 * c2}')
print(f'Деление большего на меньшее - {c2 / c1}')
print(f'Деление меньшего на большее - {c1 / c2}')
print(f'Организация ячеек по 4 в ряд - ')
c1.make_order(4)
